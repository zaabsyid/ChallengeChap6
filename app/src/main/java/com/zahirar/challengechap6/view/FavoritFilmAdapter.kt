...
import com.zahirar.challengechap6.databinding.ItemFilmFavoritBinding
import com.zahirar.challengechap6.model.FavoriteResponseItem
import com.zahirar.challengechap6.model.GetFilmResponseItem

class FavoritFilmAdapter(var listFilm : List<FavoriteResponseItem>): RecyclerView.Adapter<FavoritFilmAdapter.ViewHolder>() {

    var onUnfavoriteClick : ((FavoriteResponseItem)->Unit)? = null
